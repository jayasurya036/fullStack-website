...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../asserts/css/newPost.css">
...
<div class="wrapper">
		...
		<div class="mainBody">
			...
			<div class="mainBar">
					...
					<form name="postUpload" class="newPostForm" action="uploadNewPost.php" method="post" enctype="multipart/form-data">
						
						<input type="file" name='postImage' class="imageUp">
						<input type="text" name="postHeading" placeholder="heading of the post" class="headingUp">
						<textarea name="postData" id="" cols="20" rows="10" placeholder="write the post down here"></textarea>
